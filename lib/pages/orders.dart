...
import 'package:washi_mobile_app_flutter/entities/Order.dart';
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      child: Text(orders[index].cost,textAlign: TextAlign.center, style: TextStyle(
                                          fontSize: 18
                                      ),),
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Container(
                                      child: Text(orders[index].status,style: TextStyle(
                                        fontSize: 19,
                    ...
                    child: Column(
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(
                            order.laundryName, style: TextStyle(fontSize: 25),
                          ),
                        ),
                        Container(
                          child: Row(
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text(
                                  order.date, style: TextStyle(fontSize: 18),
                                ),
                              ),
                            ],
                          ),
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text(
                                  order.deliveryDate, style: TextStyle(fontSize: 18),
                                ),
                              ),
                            ],
                          ),
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text(
                                  order.status, style: TextStyle(fontSize: 18),
                                ),
                              ),
                            ],
                          ),
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text(
                                  order.cost, style: TextStyle(fontSize: 18),
                                ),
                              ),
                            ],
                          ),
